    ...
    <div class="card card-outline-navy rounded-0">
        <div class="card-header">
            <div class="d-flex w-100 align-items-center">
                <div class="col-auto">
                    <img src="uploads/logo.png" class="img-fluid img-thumbnail rounded-circle" style="width:1.9em;height:1.9em;object-fit:cover;object-position:center center" alt="Chatty">
                </div>
                <div class="col-auto">
                    <b>Chatty</b>
                </div>
        ...
        <div class="card-body">
            <div class="overflow-auto" id="convo-box">
                ...
                <div class="d-flex w-100 align-items-center mt-4">
                    <div class="col-auto">
                        <img src="uploads/logo.png" class="img-fluid img-thumbnail rounded-circle" style="width:2.5em;height:2.5em;object-fit:cover;object-position:center center" alt="Chatty">
                    </div>
                    <div class="col-auto flex-shrink-1 flex-grow-1">
                        <div class="msg-field bot-msg w-auto d-inline-block bg-gradient-light border rounded-pill px-3 py-2">Hi there! Welcome to EVSU FAQ Chat Bot. I'm "Chatty". How may I help you?".</div>
                    </div>
                </div>
            </div>
            <div class="d-flex w-100 align-items-center">
